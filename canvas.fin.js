...
window.onload = function () {
    ...
    var f_Interval = setInterval(function () {
        ...
        for (var i = 0; i < 1; i++) {
            ...
            f_tag = $('.tag').eq(x).text();
            arr_f_txt = ["我都三刷了，你們怎麼還在這?", "必看，快去看", "覺得普普", "大概是今年之最了", "看的很過癮", "好看 很多地方值得深思～", "兼顧劇情的爽片 ", "還不錯啊", "獨樹一幟", "搭配音樂的表現方式也令人驚豔", "不懂為什麼分數不高", "Good~~~~~", "個人覺得好看，就這樣", "每個人的演技都相當好", "我覺得這部電影很舒壓", "有進步很多了～好看", "腦洞開很大 挺有趣的", "覺得不錯", "看完後去細想是有內容的", "娛樂性十足，瑕不掩瑜"]
